...
class ShowWeather extends StatefulWidget {
  String city;
  ShowWeather({Key? key, required this.city}) : super(key: key);
  @override
...
class _ShowWeatherState extends State<ShowWeather> {
  ...
  void queryWeather() async {
    ...
    Weather weather = (await ws.currentWeatherByCityName(name));
    setState(() {
      _data = [weather];
